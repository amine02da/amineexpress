                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                style="background-image: url({{$products[0]->UrlImage}});">
                                <div class="content">
                            ...
                            <div class="single-slider"
                                ...
                                <div class="content">
                                    ...
                                    <h3><span>Combo Only:</span> {{App\helpers\Currency::format($products[0]->price)}}</h3>
                                    <div class="button">
                                        <a href="product-grids.html" class="btn">Shop Now</a>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{$products[0]->UrlImage}}" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
