                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-images">
                                <main id="gallery">
                                    <div class="main-img">
                                        <img src="{{$product->UrlImage}}" id="current" alt="#">
                                    </div>
                                    {{-- <div class="images">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-info">
                                ...
                                <h3 class="price">{{App\Helpers\Currency::format($product->price)}}@if($product->compare_price)<span>${{$product->compare_price}}</span>@endif</h3>
