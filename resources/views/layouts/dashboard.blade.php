...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">DaStore</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{Carbon\Carbon::now()->year}}-{{Carbon\Carbon::now()->year+1}} AmineExpress.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
